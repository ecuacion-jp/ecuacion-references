 ...
 */
package jp.ecuacion.referenceapps.splib.web.config;
...
@Configuration
@EnableJpaRepositories("jp.ecuacion.referenceapps.splib.web.repository")
@ComponentScan(basePackages = "jp.ecuacion.splib.web.config"
    + ",jp.ecuacion.referenceapps.splib.web.base.config"
    )
