...
アプリケーションサーバ（Tomcat など）にデプロイして使用します。
...
- [セットアップ](/public/ja/article?id=command-api/setup)
- [クイックスタート](/public/ja/article?id=command-api/quickstart)
- [API仕様](/public/ja/article?id=command-api/api-spec)
