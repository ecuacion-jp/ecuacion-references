...
It is deployed to an application server such as Tomcat.
...
- [Setup](/public/en/article?id=command-api/setup)
- [Quick Start](/public/en/article?id=command-api/quickstart)
- [API Spec](/public/en/article?id=command-api/api-spec)
