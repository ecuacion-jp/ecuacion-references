 ...
 */
package jp.ecuacion.referenceapps.splib.web.base.bl;

import java.util.List;
import java.util.Optional;
import jp.ecuacion.referenceapps.splib.web.base.entity.*;
import jp.ecuacion.referenceapps.splib.web.base.record.*;
import jp.ecuacion.referenceapps.splib.web.base.repository.*;
