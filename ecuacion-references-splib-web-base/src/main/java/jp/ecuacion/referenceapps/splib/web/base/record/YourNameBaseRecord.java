 ...
 */
package jp.ecuacion.referenceapps.splib.web.base.record;
...
public abstract class YourNameBaseRecord extends SystemCommonBaseRecord implements ItemContainer {
  ...
  public YourNameBaseRecord() {
    super();
  }

  public YourNameBaseRecord(YourName e, DatetimeFormatParameters params) {
    super(e, params);
    this.id = (e.getId() == null) ? "" : Long.toString(e.getId());
    this.name = e.getName();
  }

  public YourNameBaseRecord(YourNameBaseRecord rec) {
    super(rec);
  }
