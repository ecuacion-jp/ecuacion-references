...
[`SplibBatchAdvice`](/public/showMarkdown/page?id=batch/current-execution-context&lang=en), so that
...
[Exception Handling](/public/showMarkdown/page?id=batch/exception-handling&lang=en), rather than as a
