...
これにより、
[ロギング](/public/showMarkdown/page?id=batch/logging&lang=ja) と
[例外処理](/public/showMarkdown/page?id=batch/exception-handling&lang=ja) は、
...
Job/Step リスナーは
[`preparedJobBuilder`/`preparedStepBuilder`](/public/showMarkdown/page?id=batch/job-and-step-builders&lang=ja)
...
[例外処理](/public/showMarkdown/page?id=batch/exception-handling&lang=ja) がログ出力するのと同じ値です。
