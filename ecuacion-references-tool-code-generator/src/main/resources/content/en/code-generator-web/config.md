...
This application runs with Spring profile `profile`. Profile-specific settings should go in **`application-profile.properties`**, placed in the same location as `application.properties`.
